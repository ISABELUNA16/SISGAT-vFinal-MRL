<?php
/* Smarty version 3.1.30, created on 2017-12-07 04:08:31
  from "C:\wamp\www\SISGAT\views\templates\clienteslistado.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a28b0af069bf4_29830041',
...
function content_5a28b0af069bf4_29830041 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="panel panel-default">
              ...
              <div class="w3-row">    
               <br>     
               <button class="w3-button w3-red" style="margin-bottom: 20px; margin-right: 5px; margin-left: 15px;" onclick="location.href='?action=clientes'">Salir <i class="fa fa-exclamation-circle"></i></button>
                <button class="w3-button w3-blue" style="margin-bottom: 20px;" onclick="javascript:crearPDF();" >Imprimir en Formato PDF  <i class="fa fa-print"></i></button>
              </div>
              <!--Table-->
              <div class="panel-body">
                <table id="tblistadoclientes" class="table table-striped table-bordered table-hover" style="color:grey; font-size:14px"  width="100%"> </table>
              </div>
            </div>
          </div>
        </div>
...
>
    <?php echo '<script'; ?>
 type="text/javascript" src="views/js/clienteslistado.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="views/js/clientesPDF.js"><?php echo '</script'; ?>
>
