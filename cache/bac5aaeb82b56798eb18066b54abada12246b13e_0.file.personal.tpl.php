<?php
/* Smarty version 3.1.30, created on 2017-12-07 03:20:55
  from "C:\wamp\www\SISGAT\views\templates\personal.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a28a5871f0253_71539350',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bac5aaeb82b56798eb18066b54abada12246b13e' => 
    array (
      0 => 'C:\\wamp\\www\\SISGAT\\views\\templates\\personal.tpl',
      1 => 1512613253,
      2 => 'file',
    ),
  ),
...
function content_5a28a5871f0253_71539350 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
  ...
  <body class="w3-light-grey" onload="javascript:MostrarPersonal();">     
      <!--BOTON DEL MENU-->
      ...
      <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:270px;" id="mySidebar">
        ...
        <div class="w3-bar-block">
          ...
          <a href="?action=mantenimientos" class="w3-bar-item w3-button w3-amber w3-padding w3-hover-blue"><i class="fa fa-cog w3-xlarge"></i>  Mantenimiento</a>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="panel panel-default">
              ...
              <br>
                <h4>MANTENIMIENTO <span class="w3-opacity w3-medium">DE PERSONAL </span></h4>
              </div> <br>
              ...
              <div class="panel-body">
                <table id="tblistapersonal" class="table table-striped table-bordered table-hover" style="color:grey; font-size:14px"  width="100%"> </table>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header"> 
                    ...
                    <h4 class="modal-title custom_align" id="Heading">NUEVO EMPLEADO</h4>
              </div>
              <div class="modal-body w3-black" id="datosCargadoss">
              </div>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header"> 
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="" aria-hidden="true"></span></button>
                    <h4 class="modal-title custom_align" id="Heading">EDITAR EMPLEADO</h4>
              </div>
      ...
      <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="" aria-hidden="true"></span></button>
              <h4 class="modal-title custom_align" id="Heading">Eliminar Empleado</h4>
            </div>
...
>
    <?php echo '<script'; ?>
 type="text/javascript" src="views/js/personal.js"><?php echo '</script'; ?>
> 
