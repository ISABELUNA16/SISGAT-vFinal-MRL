<?php
/* Smarty version 3.1.30, created on 2017-12-07 04:10:14
  from "C:\wamp\www\SISGAT\views\templates\usuariosnuevo.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a28b11624df65_68133616',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2289179878f648b4e0cdedfa6601616721288110' => 
    array (
      0 => 'C:\\wamp\\www\\SISGAT\\views\\templates\\usuariosnuevo.tpl',
      1 => 1512616212,
      2 => 'file',
    ),
  ),
...
function content_5a28b11624df65_68133616 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
  ...
  <body class="w3-light-grey">
      ...
      <hr>
        ...
        <div class="w3-bar-block">
          ...
          <a href="?action=mantenimientos" class="w3-bar-item w3-amber w3-button w3-padding w3-hover-blue"><i class="fa fa-gears w3-xlarge"></i>  Mantenimiento</a>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      <form  class="w3-dark-grey w3-padding-32 w3-margin-bottom">
        <div class="w3-container">
          <h4>NUEVO <span class="w3-opacity w3-medium">Usuario</span></h4>
          <div class="w3-row">
            <input type="text" name="razonsocial" id="razonsocial" class="w3-input w3-col m7" placeholder="*Razón social" style="margin-right: 3px;" autofocus>     
            <input type="number" name="ruc" id="ruc" class="w3-input w3-col m4" placeholder="*RUC">
          </div>
          <br>
          <div class="w3-row">
            <input type="text" name="contacto" id="contacto" class="w3-input w3-col m6" placeholder="Contacto" style="margin-right: 3px;">
             <input type="text" name="direccion" id="direccion" class="w3-input w3-col m5" placeholder="Dirección"> 
          </div>
          <br>
            <div class="w3-row">         
              <input type="number" name="telefono" id="telefono" class="w3-input w3-col m4" placeholder="*Teléfono Contacto" style="margin-right:3px;">
              <input type="text" name="email" id="email" class="w3-input w3-col m4" placeholder="Email"> 
            </div>
            <h4><span class="w3-opacity w3-medium">(*) Campos Obligatorios</span></h4>
        </div> 
        <br>
          <button class="w3-button w3-blue"  type="button" onclick="javascript:RegistrarNuevoCliente();" style="margin-left: 15px;"> Guardar  <i class="fa fa-save"></i></button>
          <button class="w3-button w3-red" type="button" onclick="location.href='?action=mantenimientos'">Cancelar <i class="fa fa-exclamation-circle"></i></button>
      </form>
    </div>
    <?php echo '<script'; ?>
...
>
    <?php echo '<script'; ?>
 type="text/javascript" src="views/js/clientesnuevo.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
