<?php
/* Smarty version 3.1.30, created on 2017-12-07 04:08:23
  from "C:\wamp\www\SISGAT\views\templates\clientesnuevo.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a28b0a70d95b0_20359673',
...
function content_5a28b0a70d95b0_20359673 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
  ...
  <body class="w3-light-grey">
      ...
      <hr>
        ...
        <div class="w3-bar-block">
          ...
          <a href="?action=clientes" class="w3-bar-item w3-button w3-amber w3-padding w3-hover-blue"><i class="fa fa-users w3-xlarge"></i>  Clientes</a>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      <form  class="w3-dark-grey w3-padding-32 w3-margin-bottom">
        ...
        <br>
          ...
          <button class="w3-button w3-red" type="button" onclick="location.href='?action=clientes'">Cancelar <i class="fa fa-exclamation-circle"></i></button>
      </form>
    </div>
    <?php echo '<script'; ?>
