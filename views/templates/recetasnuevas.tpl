...
<html>
  ...
  <body class="w3-light-grey" onload="javascript:cargarCombox();">
      ...
      <div class="modal fade" id="product" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        ...
        <script  src="views/js/recetasnuevas.js" type="text/javascript"></script>
        <script type="text/javascript" src="views/js/notify.js"></script>

        <script type="text/javascript" src="views/js/jspdf.js"></script>
        <script type="text/javascript" src="views/js/pdfFromHTML.js"></script>
