  ...
  <!-- CONTENIDO DE LA PAGINA-->
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      <form  class="w3-dark-grey w3-padding-32 w3-margin-bottom">
        ...
        <br>
          <button class="w3-button w3-blue"  type="button" onclick="javascript:RegistrarNuevoUsuario();" style="margin-left: 15px;"> Guardar  <i class="fa fa-save"></i></button>
    ...
    <script type="text/javascript" src="views/js/clientesnuevo.js"></script>
